...
detail: >
  ...
  We can make custom items like this to show your love for the Missouri Tigers. Contact us using the button below to start the conversation about a custom order!
square_url: 
makerworld_url: 
button_type: custom
---